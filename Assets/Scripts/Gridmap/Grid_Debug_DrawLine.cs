...
public class Grid_Debug_DrawLine
{
    ...
    public Grid_Debug_DrawLine(int width, int height, int cellSize, Vector3 originPosition) 
    {
        gridWidth = width;
        gridHeight = height;
        ...
        for (int x = 0; x < gridArray.GetLength(0); x++)
            ...
            {
                debugTextArray[x,y] = CreateWorldText(gridArray[x, y].ToString(), GetWorldPosition(x, y) + new Vector3(cellSize, cellSize) * 0.5f , 40, Color.white, TextAnchor.MiddleCenter);
